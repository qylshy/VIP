package com.qyl.vip.proxy.utils;
...
import static com.qyl.vip.proxy.utils.Preconditions.checkArgument;
...
public class VideoProxyUtil {
    public static final String LOG_TAG = "VideoProxy";
